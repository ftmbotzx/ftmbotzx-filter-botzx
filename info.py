...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://ftm:ftm@cluster0.8hbsnml.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
FTM_GAMMA_MODE = is_enabled((environ.get('FTM_GAMMA_MODE', "False")), False)  # FTM Gamma Mode On (True) / Off (False)
...
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN') else (APP_NAME or 'defaultapp')+'.herokuapp.com'
